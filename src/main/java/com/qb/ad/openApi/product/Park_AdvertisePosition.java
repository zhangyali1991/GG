...
public class Park_AdvertisePosition {
    static String adPosIds = "4";//1#2#3#4#5  1入场推送，2出场推送，3输入车牌 ，4支付页面，5付款成功
    static String medium = "1";//1:微信公众号 2:微信小程序 3:app
...
//        createAdvertisePositionV2("2", parkId , DataProduct.partnerId , DataProduct.priv_key); //v1必须填status
        createAdvertisePosition("4", parkId , DataProduct.partnerId , DataProduct.priv_key,medium);
        //更新广告位
